...
| historyInDateOrder | boolean | Whether status_date increases down the history. **It does not** on the fixtures with a FAILURE in them: the array's order is the sequence, and the dates disagree with it |
